...
tiff(file = paste("FIELD",x,"Daily Soil_Moisture",sD,"-",eD, ".tiff"), width = 3200, height = 2100, units = "px", res = 400) 
...
text(x = corners2[2]+corners2[2]/5000, y = mean(corners2[3:4])-52, "Irrigation\n(mm)",srt=270,cex=0.6)
text(x = corners2[2]+corners2[2]/12000, y = mean(corners2[3:4])-52, "20\n10\n0",las=0,cex=0.65)
...
#export graphs to tiff####
tiff(file = paste("FIELD",x,"Daily_Soil_Moisture",sD,"-",eD, ".tiff"), width = 3200, height = 2100, units = "px", res = 400) 
#FES plot####
#Soil moisture plot
par(mar=c(5.1,4.1,4.1,3.1))
plot(df1$value ~ df1$Date, 
     type = "l",
     ylim = c(ymin-0.02,ymax+0.04),
     ylab="",
     xlab="",
...
corners2 = par("usr") #Gets the four corners of plot area (x1, x2, y1, y2)
par(xpd = TRUE) #Draw outside plot area
text(x = corners2[2]+corners2[2]/5000, y = mean(corners2[3:4])-66, "Irrigation\n(mm)",srt=270,cex=0.6)
text(x = corners2[2]+corners2[2]/12000, y = mean(corners2[3:4])-65, "20\n10\n0",las=0,cex=0.65)
...
# arrows(x0 =as.Date("2019-06-01"),length=0.05, y0 = 0.03, y1 = 0.0)
# text(x = as.Date("2019-06-01"), y = 0.035,labels=expression(paste("Drought Treatment Initiated")),cex=0.6)
...
legend("topleft", y = NULL, 
       legend=c("aT-Con","aT-Drt"), 
       col = c(4,4),lty=c(1,2),lwd=1.5,cex=0.75)
# arrows(x0 =as.Date("2018-06-01"),length=0.05, y0 = 0.03, y1 = 0.0)
# text(x = as.Date("2018-06-01"), y = 0.035,labels=expression(paste("Drought Treatment Initiated")),cex=0.6)
