...
#request examine high values####
tiff(file = paste("summary ambient drought",x,sD,"-",eD, ".tiff"), width = 1600, height = 1050, units = "px", res = 200) 
#visualise
with(df2,plot(maxavg~Date,main="Ambient Drought"))
abline(h=40, lty=2)
dev.off()

#second graph
tiff(file = paste("summary elevated drought",x,sD,"-",eD, ".tiff"), width = 1600, height = 1050, units = "px", res = 200) 
#visualise
with(df4,plot(maxavg~Date,main="Elevated Drought"))
abline(h=40, lty=2)
dev.off()

#extras
tiff(file = paste("summary ambient control",x,sD,"-",eD, ".tiff"), width = 1600, height = 1050, units = "px", res = 200) 
#visualise
with(df1,plot(maxavg~Date,main="Ambient Control",ylim=c(15,41)))
abline(h=40, lty=2)
dev.off()

#extras
tiff(file = paste("summary elevated control",x,sD,"-",eD, ".tiff"), width = 1600, height = 1050, units = "px", res = 200) 
#visualise
with(df3,plot(maxavg~Date,main="Elevated Control",ylim=c(15,41)))
abline(h=40, lty=2)
dev.off()
