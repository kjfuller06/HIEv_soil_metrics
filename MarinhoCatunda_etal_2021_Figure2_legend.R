tiff(file = "MarinhoCatunda_etal_2021_Figure2_legend.tiff", width =900, height = 900, units = "px", res = 200)
...
legend(title = "Colours","center", y = NULL, 
       ...
       lty=c(1, 1, 1, 1, 1, 3), col = c('blue', 'lightskyblue', 'red4', 'red'), lwd=c(10, 10, 10, 10),bty='n')
